...
```text
In an nn chessboard, Prince and Princess plays a game. The squares in the chessboard are numbered
...
Figure 2 belows show a 33 square, a possible route for Prince and a different route for Princess.



Universidad de Valladolid OJ: 10635  Prince and Princess 2/2
...
the King, Ignore some jumps and make sure that youre always together.

For example, if the Prince ignores his 2nd, 3rd, 6th jump, hell follow the route: 1 > 4 > 8 >
9. If the Princess ignores her 3rd, 4th, 5th, 6th jump, shell follow the same route: 1 > 4 > 8 >
