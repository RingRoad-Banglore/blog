---
title: Uva 01522  Lights (extreme)
---
...
10 000 000), m (1  m  10 000 000), and v (0  v  n). The last line of input will hold the values 0
0 0 and must not be processed.
...
Note: This problem is a extreme case of problem 12199.
