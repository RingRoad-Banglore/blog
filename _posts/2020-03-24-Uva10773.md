...
You are trying to cross a river of width d meters. You are given that, the river flows at v ms1 and
you know that you can speed up the boat in u ms1. There may be two goals how to cross the river:
...
the flow of the river doesnt take the boat away, and the boat passes the river in a line perpendicular to
