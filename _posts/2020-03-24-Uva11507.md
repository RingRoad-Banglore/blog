---
title: Uva 11507  Bender B Rodriguez Problem
---
...
```
Bender is a robot built by Moms Friendly Robot Company at its plant in Tijuana, Mexico in 2996. He
is a Bending-Unit 22, serial number 2716057 and chassis number 1729. He was created for the task of
bending metal wires.

Bender needs to bend a wire of length L (L  2 an integer). The wire is represented in the Benders
...
taken at the point (L j, 0, 0), and must be one of the following:
 ...
 No if the wire isnt bended at point (L j, 0, 0).
...
Universidad de Valladolid OJ: 11507  Bender B. Rodriguez Problem 2/2
