...
is the face-value (A=Ace, 29, T=10, J=Jack, Q=Queen, K=King) and the second character is the suit
...
Note that the order of the cards in the players hand is irrelevant, but the order of the cards in the
...
Universidad de Valladolid OJ: 131  The Psychic Poker Player 2/2
