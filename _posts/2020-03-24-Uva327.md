...
before a variable, that variables value is incremented (by one) before the variables value is used in
...
Heres another, more algorithmic, approach to explaining the ++ and -- operators. Well consider
