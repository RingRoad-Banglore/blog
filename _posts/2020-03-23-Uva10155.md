...
produced many great mathematicians including Descartes, Laplace and Fermat. Fermat’s famous last
...
source for rendering the math is one possibility, but it isn’t always easy to read, especially for low-TEX
people.
...
The skinnier one should be centered horizontally; if it can’t be centered exactly it should be placed one
...
positioned above and to the right of the base with no extra space added. The result’s LVC will be in
line with the base’s LVC.
...
## Sample Input
<p>x^n+y^n=z^n</p><p>1/{1+1/{1+1/{1+x}}}</p><p>123/1/12</p><p>123/{-1/12}</p><p>a^b^c+4/(1+x/{1-x})^{x-y}</p><p></p>

## Sample Output
<p>n n n</p><p></p><p>x + y = z</p><p></p><p>1</p><p>-------------</p><p></p><p>1</p><p>1 + ---------</p><p></p><p>1</p><p>1 + -----</p><p></p><p>1 + x</p><p></p><p>123</p><p>---</p><p>1</p><p></p><p></p><p></p><p>Universidad de Valladolid OJ: 10155 – Green Eggs and Ham 3/3</p><p></p><p>---</p><p>12</p><p></p><p>123</p><p>---</p><p>-1</p><p>--</p><p>12</p><p></p><p>c</p><p>b 4</p><p></p><p>a + ----------------</p><p>x - y</p><p></p><p>( x )</p><p>(1 + -----)</p><p>( 1 - x)</p>