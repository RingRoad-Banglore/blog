---
title: Uva 01364  Knights of the Round Table
---
...
Knights can easily get over-excited during discussionsespecially after a couple of drinks. After some
unfortunate accidents, King Arthur asked the famous wizard Merlin to make sure that in the future
no fights break out between the knights. After studying the problem carefully, Merlin realized that the
fights can only be prevented if the knights are seated according to the following two rules:
...
Universidad de Valladolid OJ: 1364  Knights of the Round Table 2/2
