...
connected by m passages. Each passage is colored into some color ci. Visitors of the labyrinth are
...
exists i such that ai < bi, and aj = bj for all j < i.
```
...
is described with three integer numbers: ai, bi, and ci  the numbers of rooms it connects and its
color (1  ai, bi  n, 1  ci  109). Each passage can be passed in either direction. Two rooms can be
