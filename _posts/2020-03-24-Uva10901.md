...
river that can take n cars
across the river in t min-
utes and return in t minutes.
...
unloads its cargo and loads up to n cars that are waiting to cross. If there are more than n, those that
...
```text
The first line of input contains c, the number of test cases. Each test case begins with n, t,m. m lines
...
Universidad de Valladolid OJ: 10901  Ferry Loading III 2/2
