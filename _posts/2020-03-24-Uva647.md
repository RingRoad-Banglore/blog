...
Furthermore, there are some squares such that if a players counter lands on them, then the player must
...
definitions are terminated by a line containing two 0s.
