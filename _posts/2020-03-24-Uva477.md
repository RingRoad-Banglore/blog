---
title: Uva 00477  Points in Figures Rectangles and Circles
---


```
Given a list of figures (rectangles and circles) and a list of points in the x-y plane, determine for each
...
figure (r, c for rectangle or circle, respectively). This character will be followed by values which
...
Universidad de Valladolid OJ: 477  Points in Figures: Rectangles and Circles 2/2
