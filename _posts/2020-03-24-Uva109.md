...
a kingdom destroys that kingdoms power plant (without loss of life).
...
where the x, y coordinates of vi = (xi, yi); the edges of the polygon are from vi to vi+1 for i = 0 . . . n1.
