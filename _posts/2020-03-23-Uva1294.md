---
title: Uva 01294  Mini-Spreadsheet
---

1294 Mini-Spreadsheet
Given cells filled with functional formulas and data, display the calculated results of a mini–spreadsheet.
...
Input beginning with ‘R’ indicates a particular row’s data. Any row not accounted for should be
filled with blanks. If a row is listed, all entries in the row are listed, from left to right, separated by
blank(s). A row’s entries may extend over more than one line.
...
## Sample Input
<p>R1 8 4 5 7 B 4 3 6 90 B</p><p>R3 7 8 11 14 Average(A3:D3,A3) SumF(A1 A2) B B B B</p><p>R5 B 3 4 B B B B B B Large( B1:B10 , 3)</p><p>R6 B 4 3 B B B B B B Average(4, J7)</p><p>R7 B CountIf(B1:B6,">0") LARGE(C1:C6,D1:E6,1) B B</p><p>B B B</p><p>B Large(B1:B10, 5)</p><p>R10 B Mode(A1:I1) Median(A1:I1,B1:B3) B B B B B B SUMIF(B5:C6,">3",A1:D1)</p><p></p>

## Sample Output
<p>A B C D E F G H I J</p><p></p><p>1 8 4 5 7 4 3 6 90</p><p>2</p><p>3 7 8 11 14 9#SYN#</p><p>4</p><p>5 3 4 3</p><p>6 4 3 #INP#</p><p>7 4 14 #ERR#</p><p>8</p><p>9</p><p></p><p>10 4 5 9</p>