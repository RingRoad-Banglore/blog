...
contests like Xian 2006, Beijing 2007 and Wuhan 2009, or UVa OJ contests like

Rujia Lius Presents 1 and 2), he occasionally sets easy problem (for example, the
...
the problem more difficult (and interesting!), youll have to answer m such queries.
```
