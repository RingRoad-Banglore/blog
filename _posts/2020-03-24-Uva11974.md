---
title: Uva 11974  Switch The Lights
---
...
noone understands the Chineese documentation of the system, so we must wait for support from man-
ufacturers. But we have good programmers, and we are interested in finding the minimal number of
switches required to turn off all lights in the university. Initially, all lights are turned on.
```
