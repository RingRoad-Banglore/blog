---
title: Uva 01032  Intersecting Dates
---


```
A research group is developing a computer program that will fetch historical stock market quotes from
a service that charges a fixed fee for each days quotes that it delivers. The group has examined the
...
Each input date will be given in the form Y Y Y YMMDD. Y Y Y Y is the year (1700 to 2100), MM
...
Universidad de Valladolid OJ: 1032  Intersecting Dates 2/2
