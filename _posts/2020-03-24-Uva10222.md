...
a program that was able to decode that professors speech. After his invention, everyone got comfort
...
the computer screen, dont get thundered! Because now your job is to write the same program which
can decode that mad teachers speech!
```
