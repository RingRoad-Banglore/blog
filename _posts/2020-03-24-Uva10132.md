...
and all of the file fragments were found. Unfortunately, the files didnt all break in the same place, and
the fragments were completely mixed up by their fall to the floor.

Youve translated the original binary fragments into strings of ASCII 1s and 0s, and youre planning
...
Each fragment consists of a string of ASCII 1s and 0s.
...
Output is a single line of ASCII 1s and 0s giving the bit pattern of the original files. If there are
