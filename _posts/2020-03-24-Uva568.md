---
title: Uva 00568  Just the Facts
---
...
```text
The expression N !, read as N factorial, denotes the product of the first N positive integers, where N
...
For this problem, you are to write a program that can compute the last non-zero digit of any factorial
for (0  N  10000). For example, if your program is asked to compute the last nonzero digit of 5!,
your program should produce 2 because 5! = 120, and 2 is the last nonzero digit of 120.
```
