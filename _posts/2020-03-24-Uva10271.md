...
possible, but the length of the extra one is not important, as long as its the longest. To make things
clearer, for the set of chopsticks with lengths A, B, C (A  B  C), (A B)2 is called the badness
of the set.

Its December 2nd, Mr.Ls birthday! He invited K people to join his birthday party, and would like
...
There are N positive integers Li on the next line in nondecreasing order indicating the lengths of
