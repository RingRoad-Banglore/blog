...
they are in a straight line horizontally, vertically, or diagonally, with a disk of the current players color
...
piece of the current players color, unless the current player has no legal move. If the current
...
Universidad de Valladolid OJ: 220  Othello 3/3
