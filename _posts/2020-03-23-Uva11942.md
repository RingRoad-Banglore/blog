...
## Input
The input starts with line containing a single integer N , 0 < N < 20, which is the number of groups to
process. Following this are N lines, each containing ten distinct positive integers less than 100.

## Output
There is a title line, then one line per set of beard lengths. See the sample output for capitalization
and punctuation.

## Sample Input
<p>3</p><p>13 25 39 40 55 62 68 77 88 95</p><p>88 62 77 20 40 10 99 56 45 36</p><p>91 78 61 59 54 49 43 33 26 18</p><p></p>

## Sample Output
<p>Lumberjacks:</p><p>Ordered</p><p>Unordered</p><p>Ordered</p>