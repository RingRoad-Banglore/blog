...
exists an increasing succession of numbers 0 = b0 < b1 < b2, . . . < bk1  bk = m such that i-th scriber
gets a sequence of books with numbers between bi1 + 1 and bi. The time needed to make a copy of
