---
title: Uva 00839  Not so Mobile
---

839 Not so Mobile
Before being an ubiquous communications gadget, a mobile was
...
The figure illustrates a simple mobile. It is just a wire, sus-
pended by a string, with an object on each side. It can also be
seen as a kind of lever with the fulcrum on the point where the
string ties the wire. From the lever principle we know that to balance a simple mobile the product of
the weight of the objects by their distance to the fulcrum must be equal. That is Wl ×Dl = Wr ×Dr
where Dl is the left distance, Dr is the right distance, Wl is the left weight and Wr is the right weight.
...
Universidad de Valladolid OJ: 839 – Not so Mobile 2/2
...
## Sample Input
<p>1</p><p></p><p>0 2 0 4</p><p>0 3 0 1</p><p>1 1 1 1</p><p>2 4 4 2</p><p>1 6 3 2</p><p></p>
