...
Consider three political parties. Assume h1 = 3, h2 = 4 and h3 = 8 where hi is the hartal parameter
...
the number of political parties in this case. The i th of the next P lines contains a positive integer hi
