...
daily sales amounts. And let B = (b1, b2, . . . , bn1) be another integer list maintained by Mr. Cooper,
each value representing the number of such previous days. On the i-th day (2  i  n), he calculates
bi1, the number of aks such that ak  ai (1  k < i).

For example, suppose that A = (20, 43, 57, 43, 20). For the fourth days sales amount, a4 = 43, the
