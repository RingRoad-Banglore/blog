...
4. Let b1 be equal to the number of 1s in this binary representation : b1 = 3
...
7. Let b2 be equal to the number of 1s in the last binary representation : b2 = 5
...
Campus Monterrey internal ACM programming Contest to ask for the numbers of 1s bits of this two
