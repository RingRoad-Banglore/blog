...
## Sample Input
<p>sew(turn(sew(B,turn(B))),</p><p></p><p>turn(sew(turn(B),B))) ;</p><p></p><p>sew(turn(sew(B,turn(B))),A);</p><p>sew(turn(sew(A,turn(A))),</p><p>turn(turn(</p><p></p><p>turn(sew(A,turn(A))))))</p><p></p><p>;</p><p></p>

## Sample Output
<p>Quilt 1:</p><p>||--</p><p>||--</p><p>--||</p><p>--||</p><p>Quilt 2:</p><p>error</p><p>Quilt 3:</p><p>\\//</p><p>+\/+</p><p>+/\+</p><p>//\\</p>