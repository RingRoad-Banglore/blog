...
Your task is to observe the interactions on such a website and keep track of the size of each persons
network.

Assume that every friendship is mutual. If Fred is Barneys friend, then Barney is also Freds friend.
```
