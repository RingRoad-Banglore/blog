---
title: Uva 01738  Ceiling Function
---
...
by Sample Input 1 and shown in Figure C.1. Notice that the first prototypes top layer has collapsere-
sistance value 2, the middle layer has value 7, and the bottom layer has value 1. The second prototype
...
The next n lines describe the ceiling prototypes. Each of these lines contains k distinct integers (be-
tween 1 and 106, inclusive), which are the collapse-resistance values of the layers in a ceiling prototype,
...
```
For each test case, display the number of different tree shapes on a line by itself.



Universidad de Valladolid OJ: 1738  Ceiling Function 2/2
