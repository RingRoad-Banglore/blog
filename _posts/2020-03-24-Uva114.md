---
title: Uva 00114  Simulation Wizardry
---
...
surface that has some obstacles (bumpers and walls). The surface is modeled as an m  n grid with
...
In this simulation, all positions are integral, and the balls direction is one of: up, down, left, or
...
A balls lifetime indicates how many time units the ball will live before disappearing from the surface.
