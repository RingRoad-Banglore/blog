---
title: Uva 00162  Beggar My Neighbour
---
...
and Clubs (). Within each suit there are 13 cards  Ace (A), 29, Ten (T), Jack (J), Queen (Q) and
King (K).
```
...
C) followed by the rank (A, 29, T, J, Q, K). There will be exactly one space between cards. The file will
...
winners hand (ignoring any on the stack), right justified in a field of width 3.
