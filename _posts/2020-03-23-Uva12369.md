...
next card on the table). Note that the assignments of the two joker cards don’t necessarily need to be
the same.
...
place on the table to achieve the goal (rounded to 3 decimal places). If it’s impossible to reach the goal,
irrespective of what assignments Sara opts for, output ‘-1.000’ (without the quotes) instead. Look at
samples for exact format. Judge inputs are such that small precision errors won’t cause error in the
output. If the output is ‘0.000’, make sure that you don’t print it as ‘–0.000’ (without the quotes).
...
## Sample Input
<p>4</p><p>0 0 0 0</p><p>15 13 13 13</p><p>1 2 3 4</p><p>15 15 15 15</p><p></p><p></p><p></p><p>Universidad de Valladolid OJ: 12369 – Cards 2/2</p><p></p>

## Sample Output
<p>Case 1: 0.000</p><p>Case 2: 54.000</p><p>Case 3: 16.393</p><p>Case 4: -1.000</p>