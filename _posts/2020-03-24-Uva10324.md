...
```
Given a string of 0s and 1s up to 1000000 characters long and indices i and j, you are to answer
...
```
There are multiple cases on input. The first line of each case gives a string of 0s and 1s. The next
...
Universidad de Valladolid OJ: 10324  Zeros and Ones 2/2
