...
good in geometry, but King Arthur didnt asked Lancelot to help him because he feared that he would
come up with another strange suggestion).

Can you help Galahad (since hes not too good with computers) and write a program which gives
...
```
Therell be an arbitrary number of rooms. Each room is represented by three real numbers (a, b and
