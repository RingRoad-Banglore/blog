...
Notice that each connection is one-way, i.e., the mice cant travel from b to a unless there is another
...
Universidad de Valladolid OJ: 1112  Mice and Maze 2/2
