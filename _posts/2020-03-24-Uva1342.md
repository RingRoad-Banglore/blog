---
title: Uva 01342  That Nice Euler Circuit
---
...
problem in that story was  let me remind you  to draw a graph on a paper without lifting your pen,
and finally return to the original position. Euler proved that you could do this if and only if the (planar)
graph you created has the following two properties: (1) The graph is connected; and (2) Every vertex
in the graph has even degree.

Joeys Euler machine works exactly like this. The device consists of a pencil touching the paper,
...
After all the instructions are issued, there will be a nice picture on Joeys paper. You see, since the
...
Universidad de Valladolid OJ: 1342  That Nice Euler Circuit 2/2
