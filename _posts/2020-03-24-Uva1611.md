...
The cranes software has a bug: the move counter is a 9-based (not 10-based, as you might think)
integer with at most 6 digits. Therefore, the crane stops working (and has to be serviced) after 96 =
531441 moves. Your solution must fit within this limit.
```
...
follow the cranes strange software design  use standard decimal numeral system.
