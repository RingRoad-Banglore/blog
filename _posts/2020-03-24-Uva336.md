...
TTL field by 1. If the destination of the message is the current station, then the TTL fields value is
...
we increase the TTL fields initial value to 3, starting from node
...
Universidad de Valladolid OJ: 336  A Node Too Far 2/2
