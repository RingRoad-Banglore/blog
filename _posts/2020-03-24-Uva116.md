---
title: Uva 00116  Unidirectional TSP
---
...
Traveling Salesperson Problem (TSP)  finding whether all the cities in a salespersons route can be
...
Given an mn matrix of integers, you are to write a program that computes a path of
...
For example, two slightly different 56 matrices are shown below (the only difference is the numbers
in the bottom row).
...
will be between 1 and 100 inclusive. No paths weight will exceed integer values representable using 30
bits.
