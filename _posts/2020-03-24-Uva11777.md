...
Term 1 and Term 2 exams are out of 20 each, Final is out of 30 and Attendance given is out of
...
```
The first line of input is an integer T (T < 100) that indicates the num-
ber of test cases. Each case contains 7 integers on a line in the order
Term1 Term2 Final Attendance Class_Test1 Class_Test2 Class_Test3. All these integers
...
Universidad de Valladolid OJ: 11777  Automate the Grades 2/2
