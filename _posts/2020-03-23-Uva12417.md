...
In this problem, you’re to write a formula editor. Technically, a formula is an expression, which is a
...
It’s not difficult to see that boxes are nested. If box A directly contain box B, we say box A is the
parent box of box B (for example, F1 is the parent of F2 and F3, and F3 is the parent of F4 and F5; If
box A and box B have the same parent box, we say they’re sibling boxes (for example, F4 and F5 are
...
is to the right), we say the cursor’s immediate left element is x, and immediate right element is y.
...
B, otherwise check A’s parent box (if A’s parent box has a sibling...). If none of A’s ancestor boxes
...
A’s left(right) sibling B. If there is no such B, place the cursor directly in the A’s parent box C,
...
• If the cursor’s immediate left(right) element is a fraction, place the cursor at the tail(head) position
of the numerator.

• If the cursor’s immediate left(right) element is a matrix with n rows and m rows, then place the
cursor to the tail(head) position of the box at row [n/2] and column 1(column m).

• If the cursor’s immediate left(right) element is a basic element, then place the cursor to the
...
• A fraction is formatted as follows: first, format the denominator’s box and the numerator’s box,
...
• If it is ‘Matrix’ or ‘Fraction’, then insert an 1×1 matrix or an empty fraction at the cursor, then
...
an empty line after the formula. Don’t print any trailing spaces, but don’t omit empty lines (e.g. there
...
## Sample Input
<p>-</p><p>5</p><p>Fraction</p><p>1</p><p>Down</p><p>6</p><p>Right</p><p>*</p><p>Matrix</p><p>AddCol</p><p>AddCol</p><p>1</p><p>Right</p><p>2</p><p>Right</p><p>3</p><p>Right</p><p>*</p><p>Matrix</p><p>AddRow</p><p>AddRow</p><p>1</p><p>Down</p><p>2</p><p>Down</p><p>3</p><p>Done</p><p></p><p></p><p></p><p>Universidad de Valladolid OJ: 12417 – Formula Editor 4/5</p><p></p><p>1</p><p>+</p><p>Fraction</p><p>1</p><p>Down</p><p>1</p><p>+</p><p>Fraction</p><p>1</p><p>Down</p><p>1</p><p>+</p><p>Fraction</p><p>1</p><p>Down</p><p>x</p><p>Up</p><p>Up</p><p>Right</p><p>Right</p><p>Home</p><p>Up</p><p>Done</p><p></p><p>Fraction</p><p>a</p><p>Done</p><p></p><p>Matrix</p><p>Fraction</p><p>a</p><p>Down</p><p>b</p><p>Matrix</p><p>Fraction</p><p>c</p><p>Down</p><p>d</p><p>AddRow</p><p>e</p><p>Done</p><p></p>

## Sample Output
<p>Case 1:</p><p></p><p>[1]</p><p>1</p><p></p><p>- 5---*[1 2 3]*[2]</p><p>6</p><p></p><p>[3]</p><p></p><p></p><p></p><p>Universidad de Valladolid OJ: 12417 – Formula Editor 5/5</p><p></p><p>Case 2:</p><p>1</p><p></p><p>1+-----------</p><p>1</p><p></p><p>1+-------</p><p>1</p><p></p><p>1+---</p><p>x</p><p></p><p>Case 3:</p><p>a</p><p></p><p>---</p><p></p><p>Case 4:</p><p>a</p><p></p><p>[--------]</p><p>[ e ]</p><p></p><p>b</p><p>c</p><p></p><p>[---]</p><p>d</p>