...
dialing the memorable TUTGLOP. Sometimes only part of the number is used to spell a word. When
you get back to your hotel tonight you can order a pizza from Ginos by dialing 310GINO. Another
way to make a telephone number memorable is to group the digits in a memorable way. You could
order your pizza from Pizza Hut by calling their three tens number 3101010.

The standard form of a telephone number is seven decimal digits with a hyphen between the third
and fourth digits (e.g. 8881200). The keypad of a phone supplies the mapping of letters to numbers,
as follows:
...
The standard form of TUTGLOP is 8884567, the standard form of 310GINO is 3104466, and the
standard form of 3101010 is 3101010.
...
quality control process you want to check that no two (or more) businesses in the directory have the
...
Theres a blank line between datasets.
...
Universidad de Valladolid OJ: 755  4873279 2/2
