...
following simplified regulation: you know the size of each farmers farmyard in square meters and the
number of animals living at it. We wont make a difference between different animals, although this is
...
for the farmers environment-friendliness, resulting in the premium a farmer is paid per animal he owns.
...
manys budget, which will always be a whole number. Do not output any blank lines.
...
Universidad de Valladolid OJ: 10300  Ecological Premium 2/2
