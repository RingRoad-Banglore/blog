...
```
A childrens board game consists of a square array of dots that contains lines connecting some of the
...
of n2 dots (where 2  n  9) and some interconnecting horizontal and vertical lines. A record for a
single board with n2 dots and m interconnecting lines is formatted as follows:
...
Universidad de Valladolid OJ: 201  Squares 2/2
