...
number is the prefix of another. Lets say the phone catalogue listed these numbers:
...
In this case, its not possible to call Bob, because the central would direct your
call to the emergency line as soon as you had dialled the first three digits of Bobs
