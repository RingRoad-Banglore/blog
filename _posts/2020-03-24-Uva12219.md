---
title: Uva 12219  Common Subexpression Elimination
---
...
```
Let the set  consist of all words composed of 1-4 lower case letters, such as the words a, b, f,
aa, fun and kvqf. Consider expressions according to the grammar with the two rules

E  f
E  f(E,E)

for every symbol f  . Any expression can easily be represented as a tree according to its syntax. For
...
Universidad de Valladolid OJ: 12219  Common Subexpression Elimination 2/2
