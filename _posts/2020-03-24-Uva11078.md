...
that we dont want the absolute value. Help the professor to figure out a solution.
```
...
lines contain n integers where the ith integer is the score of the ith student. All these integers have
absolute values less than 150000. If i < j, then ith student is senior to the jth student.
