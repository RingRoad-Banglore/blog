...
based services and products. On its search engine website, an interesting button Im feeling lucky
...
The question is, when one types some keywords and presses Im feeling lucky button, which web
...
which will be served to the user when Im feeling lucky.
```
...
Universidad de Valladolid OJ: 12015  Google is Feeling Lucky 2/2
