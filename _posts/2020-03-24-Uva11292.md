---
title: Uva 11292  The Dragon of Loowater
---
...
dom of Loowater, a minor nuisance
...
kept clear of the geese. Occasion-
ally, a goose would attack one of
the people, and perhaps bite off a
finger or two, but in general, the
people tolerated the geese as a mi-
nor nuisance.

One day, a freak mutation
occurred, and one of the geese
spawned a multi-headed fire-
breathing dragon. When the
...
off one of the dragons heads. The heads of the dragon are of different sizes. In order to chop off a
...
the kingdom. The next n lines each contain an integer, and give the diameters of the dragons heads,
...
Universidad de Valladolid OJ: 11292  The Dragon of Loowater 2/2
