...
}. As you can see, keys and values can be strings or integers. What’s more, values can also be dictionaries
...
## Sample Input
<p>c = {}</p><p>d = {'color': 'red', 'price': 2, 7: 'test', 100: -100}</p><p>length(d)</p><p>d[7] = {'this': 'is', 'a': 'book'}</p><p>length(d)</p><p>d[8] = {'this' : 'is', 'another' : {'a' : 'book', 'b': 'book2'}</p><p>length(d)</p><p>c[7] = c</p><p>test(c)</p><p>test(d)</p><p>length(c)</p><p>d[0] = c</p><p>length(d)</p><p>test(d[0])</p><p></p><p></p><p></p><p>Universidad de Valladolid OJ: 11886 – Infinite Dictionaries 3/3</p><p></p>

## Sample Output
<p>4</p><p>4</p><p>5</p><p>1</p><p>0</p><p>1</p><p>6</p><p>1</p>