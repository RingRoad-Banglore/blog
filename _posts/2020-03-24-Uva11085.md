---
title: Uva 11085  Back to the 8Queens
---
...
```
You are given a chess board (of 88 dimension) and there are 8 queens placed randomly on the board.
...
A move consists of moving a queen from (R1, C) to (R2, C) where 1  R1, R2  8 and R1 = R2.
