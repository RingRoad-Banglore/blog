---
title: Uva 00378  Intersecting Lines
---
...
on the plane in the order x1 y1 x2 y2 x3 y3 x4 y4. Thus each of these input lines represents two lines on
the plane: the line through (x1, y1) and (x2, y2) and the line through (x3, y3) and (x4, y4). The point
(x1, y1) is always distinct from (x2, y2). Likewise with (x3, y3) and (x4, y4).
...
## Sample Input
<p>5</p><p>0 0 4 4 0 4 4 0</p><p>5 0 7 6 1 0 2 3</p><p>5 0 7 6 3 -6 4 -3</p><p>2 0 2 27 1 5 18 5</p><p>0 3 4 0 1 2 2 5</p><p></p>

## Sample Output
<p>INTERSECTING LINES OUTPUT</p><p>POINT 2.00 2.00</p><p>NONE</p><p>LINE</p><p>POINT 2.00 5.00</p><p>POINT 1.07 2.20</p><p>END OF OUTPUT</p>