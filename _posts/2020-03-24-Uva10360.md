...
```
Baaaam! Another deadly gas bomb explodes in Manhattans underworld. Rats have taken over the
...
by a number d which specifies the rectangular radius of the gas diffusion area. For example, the figure
shows what happens when a bomb with d = 1 explodes.
...
Universidad de Valladolid OJ: 10360  Rat Attack 2/2
```
