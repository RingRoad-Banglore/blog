...
It is the annual clowns festival at your local school. For the first time in their
...
integers, c0, c1, , cN1, each representing the speed of a creature in meters per second (1  ci  10000
for each i). You can assume that they are always running in the same direction on the track.
