...
text using the decrypting technique described below. Let’s take an example. A cipher text is given as
follows:
WECGEWHYAAIORTNU
...
square of 4. These letters have to be arranged in n×n (in this example 4×4) grid and each letter from
...
## Sample Input
<p>3</p><p>WECGEWHYAAIORTNU</p><p>DAVINCICODE</p><p>DTFRIAOEGLRSI TS</p><p></p>

## Sample Output
<p>WEAREWATCHINGYOU</p><p>INVALID</p><p>DIGITAL FORTRESS</p>