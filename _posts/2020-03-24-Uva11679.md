...
However, with the elevated number of debentures and banks involved, this was an extremely com-
plicated task, so he asked for your help in writing a program that, given the banks and the debentures
...
Ri separated by spaces, indicating the monetary reserves of each one of the B banks (0  Ri  104, for
1  i  B). The N following lines contain each one three integers separated by spaces: an integer D,
indicating the debtor bank (1  D  B), an integer C , indicating the creditor bank (1  C  B and
D = C) and an integer V , indicating the debenture value (1  V  104).
...
Universidad de Valladolid OJ: 11679  Sub-prime 2/2
