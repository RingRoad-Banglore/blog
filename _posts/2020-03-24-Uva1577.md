...
power outputs of the chips are 1, 2, 6, and 7, respectively, and the difference between power outputs is
...
difference of power outputs of the two chips in each machine is at most d.
