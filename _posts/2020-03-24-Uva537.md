...
So they dont state a problem like U=10V, I=5A, P=? but rather like You have an electrical
circuit that contains a battery with a voltage of U=10V and a light-bulb. Theres an electrical current
of I=5A through the bulb. Which power is generated in the bulb?.

However, half of the pupils just dont pay attention to the text anyway. They just extract from the
text what is given: U=10V, I=5A. Then they think: Which formulae do I know? Ah yes, P=U*I.
Therefore P=10V*5A=500W. Finished.

OK, this doesnt always work, so these pupils are usually not the top scorers in physics tests. But
