...
```
It is 2012, and its a leap year. So there is a February 29 in this year, which is called leap day.
...
format. You are guaranteed that dates will be valid and the year will be in between 2  103 to 2  109.
