---
title: Uva 01006  Fixed Partition Memory Management
---


```
A technique used in early multiprogramming operating systems involved partitioning the available pri-
mary memory into a number of regions with each region having a fixed size, different regions potentially
...
si  s < si+1 for some i, then its execution time will be ti. Finally, if the programs runs in a memory
...
Universidad de Valladolid OJ: 1006  Fixed Partition Memory Management 2/2
