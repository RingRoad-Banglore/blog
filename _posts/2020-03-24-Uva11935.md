...
Leak
means that your trucks fuel tank was punctured by a sharp object. The tank will start leaking gasoline
...
always the last one. There may be multiple events at the same distanceprocess them in the order
given.
