...
cylinder. Each chamber can be empty or can contain a round. One chamber is aligned with the guns
barrel. When trigger of the gun is pulled, the guns cylinder rotates, aligning the next chamber with the
...
guns barrel, puts the gun to his head and pulls the trigger. You hear click and nothing else  the
...
can either pull the trigger right away or you can randomly rotate the guns cylinder and then pull the
...
guns chambers. 0 represent an empty chamber, 1 represent a loaded one. In this representation,
...
Universidad de Valladolid OJ: 1636  Headshot 2/2
