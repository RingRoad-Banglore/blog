---
title: Uva 12280  A Digital Satire of Digital Age
---
...
which pan is lighter (Not necessarily correct). You will have to detect whether the given information is
correct or not. If the given information is not correct you will have to rectify the picture and show it
in the output.



Universidad de Valladolid OJ: 12280  A Digital Satire of Digital Age 2/3
```

## Output

```text
First line of the input file contains a positive integer T (T  6000) that denotes the number of test sets.
The description of each set of input is given below:
...
Universidad de Valladolid OJ: 12280  A Digital Satire of Digital Age 3/3
