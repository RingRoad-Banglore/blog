...
a bit lost. But dont worry, because your friend Bruno promised you to be your tourist guide. The
problem is that he is not a very good driver, as he cant see very well (poor Bruno).

Because of his disabilities, Bruno have a lot of fines to pay and he doesnt want to have even more
...
(all of them bidirectonal) B-C, A-B, C-A, D-C, D-E, E-F and F-C. Theres a camera on C because to
go from A to E, for instance, you must pass through C. In this configuration, theres only one camera
(on C).

Your task is to help Bruno (as he wants to be a musician and he doesnt want to get even close of
...
route description will always be valid and there will be no route from one place to itself. You must read
until N = 0, and this input should not be processed.
...
Universidad de Valladolid OJ: 10199  Tourist Guide 2/2
