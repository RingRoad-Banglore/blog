...
the range [1, 250], will denote the number of disks and m, belonging to [0, 2n  1], will be the number
...
NOTES:
 ...
 There are 3 spaces between de => and the first number printed. If there isnt any number, there
should be no spaces.
