---
title: Uva 12614  Earn For Future!
---
...
Then the following line will contain N non-negative integers Ci (0  Ci < 231) separated by space,
...
operation on each pair of corresponding bits. The resulting bit of a position is 1 if the bit at that
position of both numbers is 1; otherwise, that bit is 0.
